...
function App() {
    ...
    return (
        <>
            <div className="invisible md:visible absolute -left-6 -z-20">
                <div>
            ...
            <div className="absolute left-0 w-screen h-screen -z-30 overflow-hidden">
                <div ref={vantaRef} className="absolute w-full h-full bg-black">
            ...
            <div className="flex z-0 justify-center lg:justify-end items-center h-screen lg:pr-0 text-left gap-8">
                {/* <img src={meMobile} className="md:invisible rounded-full w-auto h-32" alt="" /> */}
