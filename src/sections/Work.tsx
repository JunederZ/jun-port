    ...
    return (
        <div className="flex flex-col justify-center items-center border-transparent border-solid border-2 rounded-2xl p-4 z-[1] bg-gray-600 bg-opacity-20 hover:scale-105 transition-all duration-300 ">
            <div className='flex lg:flex-col justify-center items-center'>
                <div className=''>
                    <h1 className="text-[2dvh] lg:text-[2dvh] font-bold text-center">
                        {props.title}
                    </h1>
                ...
                <img src={props.img} alt="" className="w-auto h-[12vh] lg:h-[14dvh] p-1 lg:m-8 object-contain rounded-3xl overflow-hidden border-white border-2 bg-white" />
            </div>
            <button 
